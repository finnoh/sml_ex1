...
author: "Finn-Ole Honer, Thao Le, Jason Wang, Ramon Snellen"
format: pdf
pdf:
...
$$
It follows that $\lambda$ is the hyperparameter that determines the strength of the penalty. When $P(\beta) = \beta^{2}$, the regression is called 'ridge' regression. Similarly, when $P(\beta) = |\beta|$, the regression is called 'LASSO' regression. Finally, any combination $P(\beta) = \alpha |\beta| + (1-\alpha) \beta^{2}$ of 'ridge' and 'LASSO', where $\alpha$ denotes the weights, is called 'elastic net'.
