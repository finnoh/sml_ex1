...
```{r mape, fig.cap="Mean absolute percentage difference between glmnet and MM coefficients."}
...
```{r mae, fig.cap="Development of MAE fo decreasing precision threshold $\\epsilon$."}
plot_MAPE_eps + labs(title = TeX("Median MAE for decreasing $ \\epsilon$"))
```
